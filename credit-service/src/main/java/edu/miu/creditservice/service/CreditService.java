...
import edu.miu.creditservice.entity.Account;
    ...
    public void shipToAddress(PaymentDto paymentDto) {
        if (paymentDto.getPaymentMap() == null) {
            ...
            try {
                ...
                paymentMap.put("cardNumber", paymentInfo.getCardNumber());
                paymentMap.put("cardExpires", paymentInfo.getCardExpires());
                paymentMap.put("cardSecurityCode", paymentInfo.getCardSecurityCode());
