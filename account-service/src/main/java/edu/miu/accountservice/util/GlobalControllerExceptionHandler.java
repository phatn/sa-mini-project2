package edu.miu.accountservice.util;

import edu.miu.accountservice.exception.AuthenticationException;
import edu.miu.accountservice.exception.NotFoundException;
...
public class GlobalControllerExceptionHandler {
    ...
    public @ResponseBody HttpErrorInfo handleAuthenticationException(HttpServletRequest request, AuthenticationException ex) {
