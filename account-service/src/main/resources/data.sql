...
INSERT INTO paymentMethod(`type`, `bank_account`, `bank_routing`, `bank_name`, `owner_id`)
VALUES ('BANK', '123456', '777777', 'Tuan Anh', '1');

INSERT INTO paymentMethod(`type`, `card_expires`, `card_number`, `card_security_code`, `owner_id`)
VALUES ('CREDIT CARD', '01-2025', '999 999 999', '123', '2');

INSERT INTO paymentMethod(`type`, `paypal_number`, `paypal_token`, `owner_id`)
